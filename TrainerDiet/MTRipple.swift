...
class MTRipple: UIView {
    ...
    override init(frame: CGRect)
    {
        ...
        self.img1.image = UIImage.init(named: "circle-blue")
        self.img2.image = UIImage.init(named: "circle-blue")
        self.img3.image = UIImage.init(named: "circle-blue")
        self.img4.image = UIImage.init(named: "circle-blue")
        self.img5.image = UIImage.init(named: "circle-blue")
