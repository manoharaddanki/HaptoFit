...
public class CircularProgressBar: CALayer {
    ...
    public init(radius: CGFloat, position: CGPoint, innerTrackColor: UIColor, outerTrackColor: UIColor, lineWidth: CGFloat) {
        ...
        progressLabel.font = UIFont.boldSystemFont(ofSize: radius * 0.35)
        progressLabel.text = "0"
        progressLabel.textColor = UIColor.init(hexFromString: "23425E")
        ...
        completedLabel.textColor = UIColor.init(hexFromString: "23425E")
        completedLabel.text = ""
